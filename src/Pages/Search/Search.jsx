...
const Search = () => {
  ...
  return (
    <div className="relative flex flex-col px-6 pt-6 gap-10 w-screen h-screen bg-white dark:bg-gray-800 overflow-x-hidden overflow-y-scroll">
      ...
      {/* Search bar */}
      <div className="flex items-center w-full px-6 md:px-12 bg-white">
        <div className="flex h-14 w-full">
          <form
            action="submit"
            className="flex w-full items-center bg-slate-100 rounded-lg px-4"
            onSubmit={(e) => handleSearch(e)}
          >
            <RiSearch2Fill className="text-slate-400" fontSize={25} />
            <input
              className="w-full h-full bg-slate-100 pl-6 tracking-wider shadow-sm text-black rounded-lg  placeholder:text-slate-500 placeholder:text-sm focus:outline-none focus:shadow-outline dark:bg-gray-800 dark:text-white"
              placeholder="Search movie, show & people"
              value={searchQuery}
