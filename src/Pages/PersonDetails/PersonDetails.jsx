    ...
    <div className="relative z-10 flex w-full min-h-screen bg-white dark:bg-gray-800 overflow-y-auto overflow-x-hidden">
      ...
      <div className="flex flex-col w-full h-full">
        ...
        <div className="flex items-center mb-6 w-full justify-center">
          <div className="tabs tabs-boxed w-10/12 flex items-center justify-between h-16 rounded-3xl px-5 bg-slate-300">
            {tabs.map((tab, index) => (
              <span
                key={index}
                onClick={(e) => {
                ...
                className={
                  selectedTab === index
                    ...
                    : "tabs w-28 h-10 items-center justify-center font-medium text-black hover:text-gray-500 cursor-pointer tracking-wide"
                }
              >
                {tab}
              </span>
