  ...
  return (
    <div className="relative z-10 flex flex-col w-screen h-screen bg-white dark:bg-gray-800 overflow-x-hidden">
      ...
      <div
        ...
        className={
          "invisible lg:visible absolute z-50 top-5 left-3 flex items-center justify-center h-6 w-6 bg-white dark:bg-gray-600 cursor-pointer hover:bg-gray-50 hover:dark:bg-gray-700 shadow-md rounded-full"
        }
      >
        <i>
          {isSideBarExpanded ? (
