...
const NowPlayingSliderLoader = () => {
  return (
    <div className="flex h-1/3 w-full items-center justify-center my-8 ">
      <div className="flex h-8 w-8 items-center justify-center bg-slate-100 dark:bg-slate-700 rounded-full mx-4 tranform hover:scale-110 cursor-pointer transition-all duration-300 ease-in-out"></div>
